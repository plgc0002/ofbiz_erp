...
<div id="pieChartDivDiv" style="width:800px;height:300px;"></div>
...
jQuery(document).ready( function(){
    ...
    var data = [
        {data:d1, label: 'Completed Orders'},
        {data:d2, label: 'Approved Orders'},
        {data:d3, label: 'Pending Orders'},
        {data:d4, label: 'Cancelled Orders'},
        {data:d5, label: 'Other'}
    ];*/
    /* End Example */

    var dataAsText = 'Completed Orders,5,Approved Orders,3,Pending Orders,1,Cancelled Orders,1';
    var chartData = [];
    ...
    jQuery.plot(jQuery("#pieChartDivDiv"), allData,
    {
            series: {
                    pie: {
                            show: true,
